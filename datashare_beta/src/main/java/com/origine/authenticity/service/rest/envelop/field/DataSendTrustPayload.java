...
public class DataSendTrustPayload {
	...
	public boolean sanity() {
		return token != null && sender != null  && source != null && destinator != null  && destination != null ;
	}
	...
	public DataSendTrustPayload(String token, String sender, String source, String destinator, String destination, String content, String au_key) {
		super();
		this.token = token;
		this.sender = sender;
		this.source = source;
